...
const Searchbar = () => {
 ...
 <div>
      ...
      {/* <img src='https://p1.hiclipart.com/preview/16/942/517/filter-icon-filtering-icon-funnel-icon-options-icon-yellow-logo-sign-symbol-png-clipart.jpg' alt="img"></img> */}
        <span>Filter</span>
